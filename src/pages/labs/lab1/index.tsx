  ...
  return (
    <div id="wd-lab1">
      ...
      <div>
        ...
        <br />
        <img src="images/teslabot.jpg" height="200px" alt="" />
      </div>
      ...
      <div>
        ...
        <input type="password" value="123@#$asd" />
        <br />
        <label>Biography:</label>
        <br />
        <textarea id="wd-textarea" cols={100} rows={10}>
        ...
        <br />
        <input type="submit" value="This is another hello world" />
